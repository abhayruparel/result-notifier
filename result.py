...
def generateImage(filename):
    ...
    driver.find_element_by_xpath(
        "/html/body/form/div[3]/table[2]/tbody/tr[1]/td[2]/select/option[18]"
    ).click()
    ...
    driver.find_element_by_xpath(
        "/html/body/form/div[3]/table[2]/tbody/tr[2]/td[2]/select/option[3]"
    ).click()

    # Sem
    driver.find_element_by_name("ddlSem").click()
    driver.find_element_by_xpath(
        "/html/body/form/div[3]/table[2]/tbody/tr[3]/td[2]/select/option[6]"
    ).click()
    # Exam
